...
function render_art_list(art){
    ...
    $('.col.art').append(`<a href=art.html?art_id=${art.id}><img id="${art.id}" class="mx-1 my-1 px-1 py-1 img-thumbnail art-thumbnail" width="400" height="400" src="images/${art.file_name}" /></a>`);
